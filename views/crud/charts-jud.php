...
<!-- <?php
 ...
 <div id="content-wrapper">
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          <div class="card-header">
           ...
           Gráfica de ususarios inscritos por mes</div>
          <div class="card-body">
          ...
          <div class="col-lg-8">
            <div class="card mb-3">
              <div class="card-header">
                ...
                Gráfica de Usuarios inscritos por zona</div>
              <div class="card-body">
          ...
          <div class="col-lg-4">
            <div class="card mb-3">
              <div class="card-header">
                ...
                Gráfica de usuarios inscritos por tipo de actividad</div>
              <div class="card-body">
        ...
        <div class="col-xl-6">
            <div class="card mb-3">
              <div class="card-header">
                <i class="fas fa-chart-pie"></i>
                Gráfica de usuarios inscritos por genero</div>
              <div class="card-body">
  ...
  <script src="<?php echo constant('URL')?>public/js/demo/chart-bar-jud.js"></script>

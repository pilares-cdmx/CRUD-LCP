    ...
    <div class="card card-login mx-auto mt-5">
      ...
      <div class="card-body">
        ...
        <form>
          ...
          <a class="btn btn-primary btn-block" href="<?php echo constant('URL')?>Crud/index">Reset Password</a>
        </form>
        <div class="text-center">
          <a class="d-block small mt-3" href="<?php echo constant('URL')?>Crud/register">Register an Account</a>
          <a class="d-block small" href="<?php echo constant('URL')?>Crud/index">Login Page</a>
        </div>
      </div>
    </div>
  </div>
